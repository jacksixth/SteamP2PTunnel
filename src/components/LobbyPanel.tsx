    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="relative">
                        <div
                            className={`w-3 h-3 rounded-full ${isHost ? 'bg-blue-500' : 'bg-green-500'} animate-pulse`}></div>
                        <div
                            className={`absolute inset-0 w-3 h-3 rounded-full ${isHost ? 'bg-blue-500' : 'bg-green-500'} animate-ping opacity-75`}></div>
                    </div>
            ...
            <div className="bg-slate-950/30 rounded-lg p-4 border border-white/5 space-y-3">
                ...
                <div
                    className="flex items-center gap-2 bg-black/40 p-2 rounded border border-white/10 font-mono text-green-400 justify-center text-lg select-all">
                    127.0.0.1:{localPort}
                </div>
            </div>
